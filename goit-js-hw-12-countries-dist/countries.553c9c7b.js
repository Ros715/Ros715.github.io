...
const noticeStack = new _core.Stack({
  dir1: 'down',
  // With a dir1 of "up", the stacks will start appearing at the bottom.
  ...
  push: 'top',
  // Each new notice will appear at the bottom of the screen, which is where the "top" of the stack is. Other notices will be pushed up.
  modal: true,
  // When a notice appears in this stack, a modal overlay will be created.
  overlayClose: true,
...
const countryFlagRef = document.querySelector('.country-flag-img'); //const countryMessageToManyRef = document.querySelector('.message-too-many');
...
function displayMessageToMany() {
  ...
  countryCountryRef.setAttribute('style', 'display: none;'); //myInfo();
...
function countryInfo(searchQuery) {
  ...
  (0, _fetchCountries.default)(searchQuery).then(countries => {
...
displayNothing(); //countryInfo("eesti");
},{"@pnotify/core":"../node_modules/@pnotify/core/dist/PNotify.js","lodash.debounce":"../node_modules/lodash.debounce/index.js","./fetchCountries":"fetchCountries.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","countries.js"], null)
//# sourceMappingURL=/countries.553c9c7b.js.map