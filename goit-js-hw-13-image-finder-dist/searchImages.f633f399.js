...
function apiService(searchQuery, page, perPage) {
  const myKey = '22353815-5fa21056c210e4ef7062efe69';
  return fetch(`https://pixabay.com/api/?image_type=photo&orientation=horizontal&q=${searchQuery}&page=${page}&per_page=${perPage}&key=${myKey}`).then(response => response.json());
}
},{}],"searchImages.js":[function(require,module,exports) {
"use strict";
...
function showPhotos() {
  debounce(() => {
    (0, _apiService.default)(queryText, page, perPage).then(apiOutput => {
...
buttonNextRef.disabled = true;
},{"lodash.debounce":"../node_modules/lodash.debounce/index.js","./apiService.js":"apiService.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","searchImages.js"], null)
//# sourceMappingURL=/searchImages.f633f399.js.map